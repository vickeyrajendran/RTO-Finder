...
<td>Coimbatore</td>
    ...
    // convert a string into Dom object
...
const rtoData=[]
const tbodyChildrenArray=[...tbodyChildrens]
   
let id=0       //    creating id 
tbodyChildrenArray.forEach(record => {
// console.log(record.children[0].innerText);

// make structure to push rto data
    rtoData.push({
            id:id,
            rto_code : record.children[0].innerText,
